...
func loadConfig() config {
	...
	return config{
		...
		PublicSecurityRecordNo:      env("XICEMC_PUBLIC_SECURITY_RECORD_NO", "粤公网安备44030002013184号"),
		PublicSecurityRecordURL:     env("XICEMC_PUBLIC_SECURITY_RECORD_URL", "https://beian.mps.gov.cn/#/query/webSearch?code=44030002013184"),
